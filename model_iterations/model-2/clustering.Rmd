...
qplot(x = time_pc1, y = time_pc2, color = cluster, data = riders_final)
qplot(x = length_pc1, y = length_pc2, color = cluster, data = riders_final)
qplot(x = freq, y = prop_weekend, color = cluster, data = riders_final)
