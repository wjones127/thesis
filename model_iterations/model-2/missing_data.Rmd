...
packages <- c("ggplot2", "gamm4", "lubridate", "dplyr", "knitr", "AUC")
...
save(model_y, model_r, file = "missing_data_models.RData")
```
...
ggsave(sep_plot, file = "missing_plots/em-separation-plot.pdf", width = 4, height = 0.25)
