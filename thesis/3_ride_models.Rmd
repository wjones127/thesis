...
tranformed terms. But it's more difficult to estimate $T$ and $\phi$. Except we
...
$\phi$ isn't actually that much of a problem, because we can rewrite this
function as a sum of two trignometric terms with no phase shift:
...
which can easily be done in any package that estimates generalized linear
regressions.
